    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col gap-2 mb-6">
          {['2 free courses instantly', 'Certificate of completion', 'Community access'].map((perk) => (
        ...
        <div className="bg-[#111118] border border-white/5 rounded-2xl p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[#111118] px-3 text-xs text-slate-600">or continue with</span>
            </div>
          </div>

          <button className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 py-3 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2">
          ...
          <p className="text-center text-xs text-slate-600 mt-4">
            ...
            {' '}and{' '}
            <Link href="/privacy" className="text-slate-500 hover:text-slate-300">Privacy Policy</Link>
          </p>
        </div>
